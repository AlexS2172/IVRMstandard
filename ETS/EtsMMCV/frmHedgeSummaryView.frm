...
Begin VB.Form frmHedgeSummaryView 
   ...
   Begin EtsMMCv.ctlHedgeSummaryView ctlView 
      Height          =   4275
      Left            =   0
      TabIndex        =   5
      Top             =   0
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgStop 
         Height          =   240
         Left            =   2340
         MouseIcon       =   "frmHedgeSummaryView.frx":0E42
         MousePointer    =   99  'Custom
         Picture         =   "frmHedgeSummaryView.frx":0F94
         ToolTipText     =   "Cancel"
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgStopDis 
         ...
         Height          =   240
         Left            =   2340
         Picture         =   "frmHedgeSummaryView.frx":10DE
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      End
