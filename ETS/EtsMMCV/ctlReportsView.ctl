...
'        End If
        ...
        End If
                ...
                If (Not aTrd.Und.Dividend Is Nothing) Then
...
'                        .TextMatrix(i, 1) = aRiskMatrixShiftAtom.Shift
                        .TextMatrix(i, 2) = aRiskMatrixShiftAtom.Price
                        .TextMatrix(i, 3) = aRiskMatrixShiftAtom.MarketValue
                        .TextMatrix(i, 4) = aRiskMatrixShiftAtom.MarketValueChange
                        ...
                        .TextMatrix(i, 9) = aRiskMatrixShiftAtom.NetGamma
            ...
            For Each aUnd In m_Und
                ...
                For Each aOpt In aUnd.Opt
                    ...
                    If bAdd Then
                        ...
                        .TextMatrix(i, 0) = aOpt.Account 'aUnd.Trader
...
Private Sub CopyFilters(ByVal bToPrev As Boolean)
    ...
    If bToPrev Then
        ...
        Next
        If (Len(fgFlt.TextMatrix(1, PFC_MAX_STRIKE_DISTANCE)) > 0) Then
