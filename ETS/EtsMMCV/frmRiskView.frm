...
Begin VB.Form frmRiskView 
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgStop 
         Height          =   240
         Left            =   2340
         MouseIcon       =   "frmRiskView.frx":202A
         MousePointer    =   99  'Custom
         Picture         =   "frmRiskView.frx":217C
         ToolTipText     =   "Cancel"
         Top             =   45
         Visible         =   0   'False
         Width           =   240
   ...
   Begin VB.Menu mnuFile 
      ...
      End
      Begin VB.Menu mnuFileLoadStockShift 
         Caption         =   "Stock shift file..."
      End
...
Private m_bShowInformationWnd As Boolean
...
Private Sub ctlView_OnRefreshComplete()
    ...
    If m_bShowInformationWnd Then
        m_bShowInformationWnd = False
        gCmn.MyMsgBox Me, "Information has been saved in the file """ & g_Params.ScreenExportPath & m_sExportFileName & """"
    End If
    
    If ctlView.IsFirstStockShiftExecuted Then GenerateExportFileName True
    If ctlView.IsStockShiftExecuted Then
        ctlView.ExportScreen m_sExportFileName, g_Params.ScreenExportPath, g_Params.AggByHolding, ctlView.GetStockShiftInfo, SE_ADDTOEND, ctlView.IsLastStockShiftExecuted
        If Not ctlView.IsLastStockShiftExecuted Then
            ctlView.ExportAllStockShifts
        Else
            m_bShowInformationWnd = True
            ctlView.CancelStockShiftExecution
            ctlView.Refresh
            'gCmn.MyMsgBox Me, "Information has been saved in the file """ & g_Params.ScreenExportPath & m_sExportFileName & """"
        End If
    End If
...
'        g_PerformanceLog.LogMmInfo enlogUserAction, "ctlView_OnStateChange Enter", Me.Caption
    ...
    mnuUndHideAll.Enabled = (nCount > 1)
    mnuUndShowAll.Enabled = mnuUndHideAll.Enabled
    mnuUndNext.Enabled = (nCount > 2)
...
Private Sub mnuExportScreen_Click()
    ...
    bRes = ctlView.ExportScreen(m_sExportFileName, g_Params.ScreenExportPath, g_Params.AggByHolding, , SE_REWRITE)
...
Private Sub mnuFileBatchCapability_Click()
    On Error Resume Next
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "Menu ""File->Batch Capability..."" Enter. " & ctlView.GetOptionInfo, Me.Caption
        
    g_frmProjectionsCV.ShowData
        
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "Menu ""File->Batch Capability..."" Exit. " & ctlView.GetOptionInfo, Me.Caption
End Sub
...
Private Sub mnuFileLoadStockShift_Click()
    On Error Resume Next
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "Menu ""File->Load stock shift"" Enter. " & ctlView.GetOptionInfo, Me.Caption
    
    ctlView.LoadStockShift
    
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "Menu ""File->Load stock shift"" Exit. " & ctlView.GetOptionInfo, Me.Caption
End Sub
