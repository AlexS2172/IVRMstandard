...
Begin VB.Form frmIndexHedge2View 
   Caption         =   "Two Indices Hedge"
   ClientHeight    =   8610
   ClientLeft      =   165
   ClientTop       =   735
   ClientWidth     =   11490
   Icon            =   "frmIndexHedge2View.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   8610
   ScaleWidth      =   11490
   StartUpPosition =   3  'Windows Default
   Begin EtsMMCv.ctlIndexHedge2View ctlView 
      Height          =   6315
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgStopDis 
         ...
         Height          =   240
         Left            =   2040
         Picture         =   "frmIndexHedge2View.frx":0E42
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      End
      Begin VB.Image imgStop 
         Height          =   240
         Left            =   2040
         MouseIcon       =   "frmIndexHedge2View.frx":0F8C
         MousePointer    =   99  'Custom
         Picture         =   "frmIndexHedge2View.frx":10DE
         ToolTipText     =   "Cancel"
         Top             =   45
         Visible         =   0   'False
         Width           =   240
   ...
   Begin VB.Menu mnuView 
      ...
      End
      Begin VB.Menu mnuViewTot1GridLayout 
         Caption         =   "1st Index &Parameters/Totals Grid Layout..."
      End
      Begin VB.Menu mnuViewTot2GridLayout 
         Caption         =   "2nd Index Parameters/&Totals Grid Layout..."
      End
      Begin VB.Menu mnuViewUnd1GridLayout 
         Caption         =   "1st Index &Stock Grid Layout..."
      End
      Begin VB.Menu mnuViewUnd2GridLayout 
         Caption         =   "2nd Index Stock &Grid Layout..."
      End
   ...
   End
End
Attribute VB_Name = "frmIndexHedge2View"
...
'    m_sCaption = ""
'    m_sShortCaption = ""
'    g_nIndexHedge1UntitledIdx = g_nIndexHedge1UntitledIdx + 1
'    m_sFileName = "Untitled" & g_nIndexHedge1UntitledIdx & ".i2w"
'    m_bIsNew = True
'    m_sKey = sKey
...
'    mnuFileExport.Caption = "E&xport Orders..." & vbTab & "Ctrl+Shift+S"
'
...
'    On Error Resume Next
'    mnuViewRefresh.Enabled = Not ctlView.InProc And Not ctlView.LastQuoteReqNow And ctlView.IsValidFilter
'    mnuFileExport.Enabled = mnuViewRefresh.Enabled
'    mnuViewFilterRevert.Enabled = ctlView.FilterRevertEnabled
'End Sub
'
'Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
'    On Error Resume Next
'    If (KeyCode = Asc("S") Or KeyCode = Asc("s")) And IsCtrlPressed And IsShiftPressed Then
'        mnuFileExport_Click
'    End If
'End Sub
'
...
'    aStorage.SetStringValue "Type", "Value", "IndexHedge2View"
...
'    On Error Resume Next
'    Dim sPath$
'    sPath = g_Params.StockHedgeExportPath
'    If BrowseForFolder(Me, "Select folder to save orders", sPath) And Len(sPath) > 0 Then
'        ctlView.SaveOrders sPath & "\"
'        g_Params.StockHedgeExportPath = sPath
'    End If
'End Sub
'
...
'            .CancelError = True
'            .DefaultExt = ".i2w"
'            .DialogTitle = "Save Two Indices Hedge"
'            .InitDir = ""
'            .FileName = m_sFilePath & m_sFileName
'            .Filter = "ETS Two Indices Hedge (*.i2w)|*.i2w|All Files|*.*"
'            .FilterIndex = 1
'            On Error Resume Next
'            .ShowSave
...
'EH:
'    Screen.MousePointer = vbDefault
'    gCmn.ErrorMsgBox Me, "Fail to save two indices hedge."
'End Sub
'
...
'        .CancelError = True
'        .DefaultExt = ".i2w"
'        .DialogTitle = "Save Two Indices Hedge As"
'        .InitDir = ""
'        .FileName = m_sFilePath & m_sFileName
'        .Filter = "ETS Two Indices Hedge (*.i2w)|*.i2w|All Files|*.*"
'        .FilterIndex = 1
...
'        .CancelError = True
'        .DefaultExt = ".i2w"
'        .DialogTitle = "Open Two Indices Hedge"
'        .FileName = ""
'        .InitDir = m_sFilePath
'        .Filter = "ETS Two Indices Hedge (*.i2w)|*.i2w|All Files|*.*"
'        .FilterIndex = 1
...
'            aStorage.ReadData
'            If aStorage.GetStringValue("Type", "Value") = "IndexHedge2View" Then
...
'            Else
'                Screen.MousePointer = vbDefault
'                gCmn.MyMsgBox Me, "Invalid two indices hedge file."
'            End If
'        End If
'    End With
'    Exit Sub
'EH:
'    Screen.MousePointer = vbDefault
'    gCmn.ErrorMsgBox Me, "Fail to open two indices hedge."
'End Sub
'
...
'End Sub
'
'Private Sub mnuViewTot1GridLayout_Click()
'    On Error Resume Next
'    ctlView.CustomizeTotGridLayout GT_INDEXHEDGE2_TOTALS_1
'End Sub
'
'Private Sub mnuViewTot2GridLayout_Click()
'    On Error Resume Next
'    ctlView.CustomizeTotGridLayout GT_INDEXHEDGE2_TOTALS_2
'End Sub
'
'Private Sub mnuViewUnd1GridLayout_Click()
'    On Error Resume Next
'    ctlView.CustomizeUndGridLayout GT_INDEXHEDGE2_UNDERLYINGS_1
'End Sub
'
'Private Sub mnuViewUnd2GridLayout_Click()
'    On Error Resume Next
'    ctlView.CustomizeUndGridLayout GT_INDEXHEDGE2_UNDERLYINGS_2
'End Sub
'
