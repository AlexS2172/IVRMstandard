...
Begin VB.Form frmGreeksView 
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgStop 
         Height          =   240
         Left            =   2070
         MouseIcon       =   "frmGreeksView.frx":0E42
         MousePointer    =   99  'Custom
         Picture         =   "frmGreeksView.frx":0F94
         ToolTipText     =   "Cancel"
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgStopDis 
         ...
         Height          =   240
         Left            =   2070
         Picture         =   "frmGreeksView.frx":10DE
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      End
   End
   Begin EtsMMCv.ctlGreeksView ctlView 
      Height          =   3735
      Left            =   0
      TabIndex        =   0
      Top             =   0
