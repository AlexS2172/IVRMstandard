========================================================================
    ACTIVE TEMPLATE LIBRARY : TNT TestServer Project Overview
========================================================================

AppWizard has created this TNT TestServer project for you to use as the starting point for
...
_TNTTestServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_TNT TestServer.h)
        GUID definitions                                (_TNT TestServer_i.c)
        A type library                                  (_TNTTestServer.tlb)
        Marshaling code                                 (_TNT TestServer_p.c and dlldata.c)
TNT TestServer.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named TNT TestServer.pch and a precompiled types file named StdAfx.obj.
...
TNT TestServerps.vcproj
	...
	dlldata.c, TNT TestServer_i.c and TNT TestServer_p.c which are required
	to build the proxy/stub DLL.

TNT TestServerps.def
