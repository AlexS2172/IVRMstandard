...
Public Function GetIRateRuleType() As Long
...
Public Function GetShortRate(ByVal dtToday As Date, ByVal dtDate As Date) As Double
    ...
    If g_IRs(0).PointsCount > 0 Then
        GetShortRate = InterpolateRates(g_IRs(0).PointsCount, g_IRs(0).ShortRate(0), dtDate - dtToday + Date)
    Else
        GetShortRate = 0
    End If
End Function
...
Public Function GetLongRate(ByVal dtToday As Date, ByVal dtDate As Date) As Double
    ...
    If g_IRs(0).PointsCount > 0 Then
        GetLongRate = InterpolateRates(g_IRs(0).PointsCount, g_IRs(0).LongRate(0), dtDate - dtToday + Date)
    Else
        GetLongRate = 0
    End If
End Function
...
Public Function GetNeutralRate(ByVal dtToday As Date, ByVal dtDate As Date) As Double
    ...
    If g_IRs(0).PointsCount > 0 Then
        GetNeutralRate = InterpolateRates(g_IRs(0).PointsCount, g_IRs(0).NeutralRate(0), dtDate - dtToday + Date)
    Else
        GetNeutralRate = 0
    End If
End Function
...
Public Function GetHTBRate(ByVal dtToday As Date, ByVal dtDate As Date) As Double
    ...
    If g_IRs(0).PointsCount > 0 Then
        GetHTBRate = InterpolateRates(g_IRs(0).PointsCount, g_IRs(0).HTBRate(0), dtDate - dtToday + Date)
    Else
        GetHTBRate = 0
    End If
End Function
...
Public Function GetNeutralHTBRate(ByVal dtToday As Date, ByVal dtDate As Date) As Double
    ...
    If g_IRs(0).PointsCount > 0 Then
        GetNeutralHTBRate = InterpolateRates(g_IRs(0).PointsCount, g_IRs(0).NeutralHTBRate(0), dtDate - dtToday + Date)
    Else
        GetNeutralHTBRate = 0
    End If
End Function
...
Public Sub LoadInterestRates()
    ...
    While Not rsCurve.EOF
        ...
        g_IRs(nCurveCount).RuleType = DBRead(rsCurve!iRuleTypeID, 0)
