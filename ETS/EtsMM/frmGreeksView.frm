...
Begin VB.Form frmGreeksView 
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgStop 
         Height          =   240
         Left            =   2070
         MouseIcon       =   "frmGreeksView.frx":000C
         MousePointer    =   99  'Custom
         Picture         =   "frmGreeksView.frx":015E
         ToolTipText     =   "Cancel"
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgStopDis 
         ...
         Height          =   240
         Left            =   2070
         Picture         =   "frmGreeksView.frx":02A8
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      End
   End
   Begin EtsMM.ctlGreeksView ctlView 
      Height          =   3735
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGreeksView"
...
Public Sub ShowDataByFilter(ByRef aFilters As EtsGeneralLib.EtsFilterData)
    ...
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "frmGreeks ShowData Call", Me.Caption

    ctlView.ShowDataByFilter aFilters

    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "frmGreeks ShowData Done", Me.Caption
...
Public Sub Init(sKey As String)
    ...
    m_sCaption = ""
    m_sShortCaption = ""
    g_nGreeksUntitledIdx = g_nGreeksUntitledIdx + 1
    m_sFileName = "Untitled" & g_nGreeksUntitledIdx & ".gvw"
    m_bIsNew = True
    m_sKey = sKey
...
Private Sub Form_Load()
    ...
    g_Params.SetIcon WND_GREEKS, Me.hWnd, False
...
Private Sub Save(ByVal sFilePath As String, ByVal sFileName As String)
    ...
    aStorage.SetStringValue "Type", "Value", "GreeksView"
...
Private Sub mnuFileReportsView_Click()
    ...
    frmMain.ShowReports TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub

Private Sub mnuFileRiskMatrix_Click()
    On Error Resume Next
    'frmMain.ShowRiskMatrix ctlView.Group.GroupType, ctlView.Group.ID
    frmMain.ShowRiskMatrix TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub

Private Sub mnuFileRisks_Click()
    On Error Resume Next
    frmMain.ShowRisks TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub

Private Sub mnuFileTrades_Click()
    On Error Resume Next
    'frmMain.ShowTrades ctlView.Group.GroupType, ctlView.Group.ID
    frmMain.ShowTrades TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub
...
Private Sub mnuFileVolaAnalysis_Click()
    ...
    frmMain.ShowVolaAnalysis TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub

Private Sub mnuFileGreeks_Click()
    On Error Resume Next
    'frmMain.ShowGreeks ctlView.Group.GroupType, ctlView.Group.ID
    frmMain.ShowGreeks TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub

Private Sub mnuFileHedgeSummaryView_Click()
    On Error Resume Next
    'frmMain.ShowHedgeSummary ctlView.Group.GroupType, ctlView.Group.ID
    frmMain.ShowHedgeSummary TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
End Sub

Private Sub mnuFileOrders_Click()
    On Error Resume Next
    'frmMain.ShowOrders ctlView.Group.Type, ctlView.Group.ID
End Sub

Private Sub mnuFileTntCards_Click()
    On Error Resume Next
'    frmMain.ShowTntCards ctlView.Group.Type, ctlView.Group.ID
End Sub

Private Sub mnuFileStockHedge_Click()
    On Error Resume Next
'    frmMain.ShowStockHedge ctlView.Group.Type, ctlView.Group.ID
End Sub

Private Sub mnuFileIndex1Hedge_Click()
    On Error Resume Next
'    frmMain.ShowIndex1Hedge ctlView.Group.Type, ctlView.Group.ID
End Sub

Private Sub mnuFileIndex2Hedge_Click()
    On Error Resume Next
'    frmMain.ShowIndex2Hedge ctlView.Group.Type, ctlView.Group.ID
End Sub
...
Private Sub mnuFileSave_Click()
    ...
    If m_bIsNew Then
        With dlgCommon
            ...
            .CancelError = True
            .DefaultExt = ".gvw"
            .DialogTitle = "Save Greeks"
            .InitDir = ""
            .FileName = m_sFilePath & m_sFileName
            .Filter = "ETS Greeks (*.gvw)|*.gvw|All Files|*.*"
            .FilterIndex = 1
            On Error Resume Next
            .ShowSave
...
EH:
    Screen.MousePointer = vbDefault
    gCmn.ErrorMsgBox Me, "Fail to save greeks."
End Sub
...
Private Sub mnuFileOpen_Click()
    ...
    With dlgCommon
        ...
        If Err.Number = 0 Then
            ...
            aStorage.ReadData
            If aStorage.GetStringValue("Type", "Value") = "GreeksView" Then
            ...
            Else
                Screen.MousePointer = vbDefault
                gCmn.MyMsgBox Me, "Invalid greeks file."
            End If
        End If
    End With
    Exit Sub
EH:
    Screen.MousePointer = vbDefault
    gCmn.ErrorMsgBox Me, "Fail to open greeks."
End Sub

Private Sub mnuGraphicalPnL_Click()
    On Error Resume Next
    
    If ctlView.Filter(GFC_GROUPS) = TYPE_UNDERLYING Then
        frmMain.ShowGraphicalPnL TYPE_UNDERLYING, ctlView.Filter.Data(GFC_SYMBOL)
    Else
...
Private Sub mnuTntCardNew_Click()
    On Error Resume Next
'    frmTntCardEntry.NewCard Me, Nothing, Nothing, False, 10, 0#
End Sub
