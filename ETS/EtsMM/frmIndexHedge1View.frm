...
Begin VB.Form frmIndexHedge1View 
   Caption         =   "Index Hedge"
   ClientHeight    =   8565
   ClientLeft      =   165
   ClientTop       =   735
   ClientWidth     =   11655
   Icon            =   "frmIndexHedge1View.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   8565
   ScaleWidth      =   11655
   StartUpPosition =   3  'Windows Default
   Begin EtsMM.ctlIndexHedge1View ctlView 
      Height          =   4035
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgStop 
         Height          =   240
         Left            =   2040
         MouseIcon       =   "frmIndexHedge1View.frx":0E42
         MousePointer    =   99  'Custom
         Picture         =   "frmIndexHedge1View.frx":0F94
         ToolTipText     =   "Cancel"
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.Image imgStopDis 
         ...
         Height          =   240
         Left            =   2040
         Picture         =   "frmIndexHedge1View.frx":10DE
         Top             =   45
         Visible         =   0   'False
         Width           =   240
      End
   ...
   Begin VB.Menu mnuView 
      ...
      Begin VB.Menu mnuViewTotGridLayout 
         Caption         =   "Parameters/Totals &Grid Layout..."
      End
      Begin VB.Menu mnuViewUndGridLayout 
         Caption         =   "Stock Grid &Layout..."
      End
   End
   ...
   End
End
Attribute VB_Name = "frmIndexHedge1View"
...
'    m_sFileName = "Untitled" & g_nIndexHedge1UntitledIdx & ".i1w"
'    m_bIsNew = True
'    m_sKey = sKey
...
'    lblStatus.Caption = ""
'    lblProcess.Caption = ""
'    If Not g_Params.WindowIcon(WND_INDEXHEDGE_1) Is Nothing Then
'        Set Icon = g_Params.WindowIcon(WND_INDEXHEDGE_1)
'    End If
...
'    aStorage.SetStringValue "Type", "Value", "IndexHedge1View"
...
'            .CancelError = True
'            .DefaultExt = ".i1w"
'            .DialogTitle = "Save Index Hedge"
'            .InitDir = ""
'            .FileName = m_sFilePath & m_sFileName
'            .Filter = "ETS Index Hedge (*.i1w)|*.i1w|All Files|*.*"
'            .FilterIndex = 1
'            On Error Resume Next
'            .ShowSave
...
'EH:
'    Screen.MousePointer = vbDefault
'    gCmn.ErrorMsgBox Me, "Fail to save index hedge."
'End Sub
'
...
'        .CancelError = True
'        .DefaultExt = ".i1w"
'        .DialogTitle = "Save Index Hedge As"
'        .InitDir = ""
'        .FileName = m_sFilePath & m_sFileName
'        .Filter = "ETS Index Hedge (*.i1w)|*.i1w|All Files|*.*"
'        .FilterIndex = 1
...
'            aStorage.ReadData
'            If aStorage.GetStringValue("Type", "Value") = "IndexHedge1View" Then
...
'            Else
'                Screen.MousePointer = vbDefault
'                gCmn.MyMsgBox Me, "Invalid index hedge file."
'            End If
'        End If
'    End With
'    Exit Sub
'EH:
'    Screen.MousePointer = vbDefault
'    gCmn.ErrorMsgBox Me, "Fail to open index hedge."
'End Sub
'
