...
Begin VB.Form frmAddExScreen 
   ...
   Begin MSComctlLib.ProgressBar ProgressBar1 
      ...
      Appearance      =   1
   End
   Begin EtsMM.cltAddExScreen cltAddExScreen1 
...
Private Sub Form_Load()
    ...
    g_Params.SetIcon WND_EXERCISE, Me.hWnd, False
...
'    On Error Resume Next
    ...
    ProgressBar1.Move 20, ScaleHeight - lH - 80, ScaleWidth / 6, lH / 2
    stStatusBar.Move ScaleWidth / 6 + 20, ScaleHeight - lH - 80, ScaleWidth - ScaleWidth / 2 - 2 * lW - 100, lH
...
Private Sub mnuFileOrders_Click()
    ...
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "Menu ""File->Orders..."" Enter. ", Me.Caption
        
    frmMain.ShowOrders TYPE_UNDERLYING, 0
    
    If Not g_PerformanceLog Is Nothing Then _
        g_PerformanceLog.LogMmInfo enLogUserAction, "Menu ""File->Orders..."" Exit. ", Me.Caption
