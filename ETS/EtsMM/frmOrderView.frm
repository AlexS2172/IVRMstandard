...
Begin VB.Form frmOrderView 
   Caption         =   "Orders"
   ClientHeight    =   7890
   ClientLeft      =   165
   ClientTop       =   735
   ClientWidth     =   10995
   Icon            =   "frmOrderView.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   7890
   ScaleWidth      =   10995
   ...
   Begin VB.PictureBox picBottom 
      ...
      End
   End
   Begin EtsMM.ctlOrderView ctlView 
      Height          =   3915
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   Begin VB.Menu mnuView 
      Caption         =   "&View"
      Begin VB.Menu mnuViewDefaultOrdSort 
      ...
      End
      Begin VB.Menu mnuViewOrdGridLayout 
         Caption         =   "&Orders Grid Layout..."
      End
   ...
   End
End
Attribute VB_Name = "frmOrderView"
...
Public Sub Init(sKey As String)
    ...
    m_sCaption = ""
    m_sShortCaption = ""
    g_nOrdersUntitledIdx = g_nOrdersUntitledIdx + 1
    m_sFileName = "Untitled" & g_nOrdersUntitledIdx & ".ovw"
    m_bIsNew = True
    m_sKey = sKey
...
Private Sub ctlView_OnStateChange()
    On Error Resume Next
    mnuViewDefaultOrdSort.Enabled = ctlView.CanSortOrdersByDefault
...
Private Sub Form_Load()
    ...
    g_Params.SetIcon WND_ORDERS, Me.hWnd, False
...
Private Sub Save(ByVal sFilePath As String, ByVal sFileName As String)
    ...
    aStorage.SetStringValue "Type", "Value", "OrdersView"
...
Private Sub mnuFileSave_Click()
    ...
    If m_bIsNew Then
        With dlgCommon
            ...
            .CancelError = True
            .DefaultExt = ".ovw"
            .DialogTitle = "Save Orders"
            .InitDir = ""
            .FileName = m_sFilePath & m_sFileName
            .Filter = "ETS Orders (*.ovw)|*.ovw|All Files|*.*"
            .FilterIndex = 1
            On Error Resume Next
            .ShowSave
...
EH:
    Screen.MousePointer = vbDefault
    gCmn.ErrorMsgBox Me, "Fail to save orders."
End Sub
...
Private Sub mnuFileOpen_Click()
    ...
    With dlgCommon
        ...
        If Err.Number = 0 Then
            ...
            aStorage.ReadData
            If aStorage.GetStringValue("Type", "Value") = "OrdersView" Then
            ...
            Else
                Screen.MousePointer = vbDefault
                gCmn.MyMsgBox Me, "Invalid orders file."
            End If
        End If
    End With
    Exit Sub
EH:
    Screen.MousePointer = vbDefault
    gCmn.ErrorMsgBox Me, "Fail to open orders."
End Sub
...
Private Sub mnuViewDefaultOrdSort_Click()
    On Error Resume Next
    ctlView.SortOrdersByDefault
End Sub
...
Private Sub mnuViewOrdGridLayout_Click()
    On Error Resume Next
    ctlView.CustomizeOrdGridLayout
End Sub
