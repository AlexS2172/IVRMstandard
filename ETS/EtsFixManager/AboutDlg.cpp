...
BOOL CAboutDlg::OnInitDialog()
{
	...
	strModules += GetModuleDescription(__uuidof(FixGServer), _T("FixGSrv.exe"));
	strModules += GetModuleDescription(__uuidof(FP::FixProviders), _T("FixProviders.dll"));
	strModules += GetModuleDescription(__uuidof(EM::Settings), _T("ETSManager.exe"));
	strModules += GetModuleDescription(__uuidof(Order), _T("MsgStruct.dll"));
	strModules += GetModuleDescription(__uuidof(MsgManager), _T("MMW.dll"));
	strModules += GetModuleDescription(__uuidof(HostProxy), _T("EgTpPrx.dll"));
	strModules += GetModuleDescription(__uuidof(Host), _T("EgTpSrv.exe"));
