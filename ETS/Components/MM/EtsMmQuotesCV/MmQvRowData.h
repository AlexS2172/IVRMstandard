...
private:
	bool GetField(MmQvOptColumnEnum enCol, _variant_t& vtRet, bool bForSorting, CMmQvOptAtom* pOptAtom, CMmQvQuoteAtom* pQuote);
...
public:
	...
	bool GetField(MmQvOptColumnEnum enCol, _variant_t& vt, bool bForSorting = false);
