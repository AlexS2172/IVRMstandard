========================================================================
    ACTIVE TEMPLATE LIBRARY : EtsIvUpdate Project Overview
========================================================================

AppWizard has created this EtsIvUpdate project for you to use as the starting point for
...
_EtsIvUpdate.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_EtsIvUpdate.h)
        GUID definitions                                (_EtsIvUpdate_i.c)
        A type library                                  (_EtsIvUpdate.tlb)
        Marshaling code                                 (_EtsIvUpdate_p.c and dlldata.c)
EtsIvUpdate.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named EtsIvUpdate.pch and a precompiled types file named StdAfx.obj.
...
EtsIvUpdateps.vcproj
	...
	dlldata.c, EtsIvUpdate_i.c and EtsIvUpdate_p.c which are required
