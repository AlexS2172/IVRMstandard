========================================================================
    ACTIVE TEMPLATE LIBRARY : ETSPerfObjects Project Overview
========================================================================

AppWizard has created this ETSPerfObjects project for you to use as the starting point for
...
_ETSPerfObjects.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ETSPerfObjects.h)
        GUID definitions                                (_ETSPerfObjects_i.c)
        A type library                                  (_ETSPerfObjects.tlb)
        Marshaling code                                 (_ETSPerfObjects_p.c and dlldata.c)
ETSPerfObjects.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named ETSPerfObjects.pch and a precompiled types file named StdAfx.obj.
...
ETSPerfObjectsps.vcproj
	...
	dlldata.c, ETSPerfObjects_i.c and ETSPerfObjects_p.c which are required
	to build the proxy/stub DLL.

ETSPerfObjectsps.def
    This module definition file provides the linker with information about the exports
