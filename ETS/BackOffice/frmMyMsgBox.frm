...
Private Const BTN_CANCEL = 2
Private Const BTN_YES = 3
Private Const BTN_NO = 4
...
' executing the form
Public Function Execute(ByVal sPrompt As String, _
...
' handling lefr-right keys
Private Sub btnButton_KeyUp(Index As Integer, KeyCode As Integer, Shift As Integer)
    On Error Resume Next
    Select Case KeyCode
