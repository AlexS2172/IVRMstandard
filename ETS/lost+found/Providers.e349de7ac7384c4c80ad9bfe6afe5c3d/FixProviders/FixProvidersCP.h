#ifndef _PROVIDERSCP_H_
#define _PROVIDERSCP_H_


template <class T>
class CProxy_FixProviderEvents : public IConnectionPointImpl<T, &DIID__OrderProviderEvents, CComDynamicUnkGITArray>
{
