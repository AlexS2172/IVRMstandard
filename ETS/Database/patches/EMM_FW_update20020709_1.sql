/*
	this script recreate 
		usp_PositionsForExternalApp_Get,
		PositionsByOptForExtApp_View,
		PositionsByStockForExtApp_View
	for use in actual generation of DB (older then 3.35.010)
...
--============================================================================================================
if not exists(select * from DataInfo where DataInfoID = 1 and keyValue = '3.35.011')
	begin
		update DataInfo set keyValue = '3.35.011' where dataInfoID = 1
		print 'DB VERSION WAS CHANGED TO 3.35.011'
	end
