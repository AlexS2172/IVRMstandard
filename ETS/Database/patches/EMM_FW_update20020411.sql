...
set nocount on 
GO
if not exists(select * from DataInfo where DataInfoID = 1 and keyValue = '3.10')
	begin
		update DataInfo set keyValue = '3.10' where dataInfoID = 1
		print 'DB VERSION WAS CHANGED TO 3.10'
	end
GO