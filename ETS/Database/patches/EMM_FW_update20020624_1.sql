...
--============================================================================================================
if not exists(select * from DataInfo where DataInfoID = 1 and keyValue = '3.34.006')
	begin
		update DataInfo set keyValue = '3.34.006' where dataInfoID = 1
		print 'DB VERSION WAS CHANGED TO 3.34.006'
	end
