/*
Changes for  Option Roots Hand Held synchronization
*/
...
if not exists(select * from DataInfo where dataInfoID = 1 and (keyValue = '3.38.040' or (keyValue = '3.38.041')))
	BEGIN
		PRINT 'You can''t run this script, because you have not run script for previous version!'
		Select cast(keyValue as varchar(25)) as 'DB version', '3.38.041' as  'Version in script' from DataInfo where dataInfoID = 1
...
*/
	...
	from OptionRoot
	where (actionDate > @dtActionDate or @dtActionDate is null) and 
...
--=============================================================================================
if not exists(select * from DataInfo where DataInfoID = 1 and keyValue = '3.38.041')
	begin
		update DataInfo set keyValue = '3.38.041' where dataInfoID = 1
	end
GO
/* RESULTS ANALYTHING */
IF @@ERROR <> 0 AND @@TRANCOUNT > 0  ROLLBACK TRANSACTION
...
BEGIN
	...
	PRINT 'DB VERSION WAS CHANGED TO 3.38.041'
	COMMIT TRANSACTION
END
