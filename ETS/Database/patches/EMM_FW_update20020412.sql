/*
	fix for MLine00000250 - "We can not see option structure of stock symbol"
*/
...
set nocount on 
GO
if not exists(select * from DataInfo where DataInfoID = 1 and keyValue = '3.11')
	begin
		update DataInfo set keyValue = '3.11' where dataInfoID = 1
		print 'DB VERSION WAS CHANGED TO 3.11'
	end
GO