...
public:
	...
	DWORD WINAPI Start(IEgTcpDriverEvents * pEvents, const COINIT ThreadingModel,
	...
	DWORD WINAPI Send(SOCKET Sock, const LPVOID const pData, const DWORD dwDataLen, BOOL bSync = TRUE);
