 ...
 #define __XDR_HEADER__  
	...
	#include <stdio.h>
	#include <stdlib.h>
//	#include "c:/iptcp/include/sys/types.h"
//	#include "c:/iptcp/include/sys/time.h"
//	#include "c:/iptcp/include/fcntl.h"
//	#include "c:/iptcp/include/sys/socket.h"
	#define	bool_t	int
	#define	enum_t	int
	...
	#define mem_free(a,b)	free(a)
		...
		#define FALSE 0
	#endif
	void		memo_Putch(char ch);
	void		memo_Printf(char *format, ...);
	...
	/* Basic system type definitions; portable between 16 and 32 bit Windows.
 	 */ 
	#if !defined(BYTE)
...
enum xdr_op {
  ...
  */
 typedef	bool_t (*xdrproc_t)(void *, char *);
...
struct xdr_ops {
	...
	void	(*x_destroy)(XDR *);					/* free privates of this void_stream */
 };
 ...
 #define XDR_DESTROY(xdrs)				if ((xdrs)->x_ops->x_destroy) (*(xdrs)->x_ops->x_destroy)(xdrs)
 #define xdr_destroy(xdrs)				if ((xdrs)->x_ops->x_destroy) (*(xdrs)->x_ops->x_destroy)(xdrs)
