// ISEStdPriceInfo.cpp : Implementation of CISEStdPriceInfo
#include "stdafx.h"
...
// CISEStdPriceInfo
/*
STDMETHODIMP CISEStdPriceInfo::InterfaceSupportsErrorInfo(REFIID riid)
{
...
STDMETHODIMP CISEStdPriceInfo::RequestLastQuote(QuoteUpdateParams* Params)
{
	_EventTypeEnum	Type;
...
STDMETHODIMP CISEStdPriceInfo::CancelLastQuote(VARIANT vtParams)
{
...
STDMETHODIMP CISEStdPriceInfo::SubscribeQuote(QuoteUpdateParams* Params)
{
	_EventTypeEnum	Type;
...
STDMETHODIMP CISEStdPriceInfo::UnSubscribeQuote(VARIANT vtParams)
{
	CSymbolParams	Request;
...
STDMETHODIMP CISEStdPriceInfo::Connect()
{
	EgTrace("CISEStdPriceInfo::Connect");
	return ((CPriceProviderManagerObject*)theISEManager)->Connect(this);
}

STDMETHODIMP CISEStdPriceInfo::Disconnect()
{
	EgTrace("CISEStdPriceInfo::Disconnect");
	return ((CPriceProviderManagerObject*)theISEManager)->Disconnect(this);
}

//----------------------------------- Group price -----------------------------------------------//

STDMETHODIMP CISEStdPriceInfo::RequestGroup(QuoteUpdateParams* Params,/*[in]*/ GroupRequestType enOperationType)
{
	_EventTypeEnum	Type;
...
STDMETHODIMP CISEStdPriceInfo::CancelGroup(VARIANT vtParams)
{
	CSymbolParams	Request;
...
void	CISEStdPriceInfo::FireOnLastQuote(const _EventTypeEnum RequestType,
...
void	CISEStdPriceInfo::FireOnQuoteUpdate(	const _EventTypeEnum RequestType,
							const CSymbolParams& RequestParams,
							const CQuoteBBO& BBO)
{
	CComVariant varParams;
...
void	CISEStdPriceInfo::FireOnError(const CSymbolParams& Request, const _EventTypeEnum RequestType,
...
*/
//--------------------------------------- CP ----------------------------------------------------//
HRESULT CISEStdPriceInfo::OnLastQuote(const CComVariant &varParams,const CComVariant &varResults)
{
	CComVariant varResult;
    ...
    ResultDest->ClosePrice = ResultSrc->ClosePrice;
    ResultDest->HighPrice = 0;
    ResultDest->LowPrice = 0;
    ResultDest->Skipped = 0;
    ResultDest->TotalRequests = 0;
    ResultDest->WaitTime = 0;
    ResultDest->NetChange = 0;
...
HRESULT CISEStdPriceInfo::OnQuoteUpdate(const CComVariant &varParams,const  CComVariant &varResults)
{
	CComVariant varResult;
	int nConnectionIndex;
	CComVariant* pvars = new CComVariant[2];
...
HRESULT CISEStdPriceInfo::OnError(ErrorNumberEnum enumError, _bstr_t bstrDescription, 
...
HRESULT	CISEStdPriceInfo::OnEvent(const EventNumberEnum EventNumber, _bstr_t Description)
{
    return S_OK;
}
