...
public:
	 ...
	 *	@throw	Exception
	 */
	IpManager(const size_t numberOfIoThreads = 0);
	 ...
	 *	@throw	Exception
	 */
	static void GetIpAddress(const std::string &nodeName, const uint16_t portNumber, IpAddress &ipAddress,
							 const int flags = 0);
...
private:
	...
	AtomicInteger					m_numberOfObjects;			///< The number of objects the manager is managing
