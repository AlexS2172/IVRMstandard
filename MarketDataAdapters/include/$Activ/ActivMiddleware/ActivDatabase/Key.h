...
public:
	 ...
	 */
	ACTIV_DATABASE_API bool operator==(const Key &rhs) const;
	 ...
	 */
	ACTIV_DATABASE_API void Initialize();
	 ...
	 *
	 *	@param	pTable table key will relate to.
	 *	@param	messageValidater the message validater from which key data will be extracted.
	 *
	 *	@retval	STATUS_CODE_SUCCESS
	 *	@retval	STATUS_CODE_INVALID_PARAMETER
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 *	@retval	STATUS_CODE_NOT_INITIALIZED
	 */
	ACTIV_DATABASE_API virtual StatusCode Deserialize(ITable *pTable, MessageValidater &messageValidater);
	 ...
	 *	@retval	STATUS_CODE_NOT_INITIALIZED
	 */
	ACTIV_DATABASE_API StatusCode SetIndexFields(const ScatterBufferHelper &scatterBufferHelper);
	 ...
	 *	@retval	STATUS_CODE_NOT_INITIALIZED
	 */
	ACTIV_DATABASE_API StatusCode GetIndexPointer(IIndex *&pIndex) const;
	 ...
	 *	@retval	STATUS_CODE_NOT_INITIALIZED
	 */
	ACTIV_DATABASE_API StatusCode GetIndexSpecification(IndexSpecification &indexSpecification) const;
	 ...
	 *	@retval	STATUS_CODE_INVALID_PARAMETER
	 */
	ACTIV_DATABASE_API StatusCode Set(const void *pRhsData);
	 ...
	 *	@retval	STATUS_CODE_NOT_INITIALIZED
	 */
	ACTIV_DATABASE_API StatusCode GetIndexNumber(IndexSpecification::Number &indexNo) const;
	 ...
	 */
	ACTIV_DATABASE_API StatusCode Validate(const ITable *pTable) const;
