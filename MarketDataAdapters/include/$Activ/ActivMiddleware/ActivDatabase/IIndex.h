...
public:
	 ...
	 */
	ACTIV_DATABASE_API virtual IndexSpecification::Number GetNumber() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual std::string GetName() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual size_t GetKeyLength() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual FieldSpecificationList GetFieldSpecificationList() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual FieldIdList GetFieldIdList() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual IndexSpecification GetSpecification() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual bool IsPrimaryUnique() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual bool IsUnique() const = 0;
	 ...
	 */
	ACTIV_DATABASE_API virtual bool IsDuplicate() const = 0;
};
