...
public:
	 ...
	 *	@brief	Destructor.
	 */
	ACTIV_DATABASE_API virtual ~Record();
	 ...
	 */
	ACTIV_DATABASE_API StatusCode Initialize(ITable *pTable);
	 ...
	 *
	 *	@param	pTable table the record will be stored in.
	 *	@param	messageValidater message validater containing the record data.
	 *
	 *	@retval	STATUS_CODE_SUCCESS
	 *	@retval	STATUS_CODE_INVALID_PARAMETER
	 *	@retval	STATUS_CODE_HEAP_EMPTY
	 ...
	 *	@retval	STATUS_CODE_NOT_INITIALIZED
	 */
	ACTIV_DATABASE_API StatusCode SetIndexFields(const IndexSpecification::Number indexNo, const ScatterBufferHelper &scatterBufferHelper);
	 ...
	 *	@retval	STATUS_CODE_INVALID_PARAMETER
	 */
	ACTIV_DATABASE_API StatusCode Set(const void *pSourceData);
