 ...
 */
class ACTIV_BASE_API BaseException : public Exception
{
public:
	/**
	 ...
	 */
	BaseException(const char *file, const char *function, const uint_fast32_t line, const uint_fast32_t errorCode);
