 ...
 */
class ACTIV_BASE_API ScatterBufferHelper
{
public:
	/**
	 *	@brief	Scatter buffer class.
	 */
	class ACTIV_BASE_API ScatterBuffer
	{
	public:
	 ...
	 */
	class ACTIV_BASE_API ConstIterator
	{
	public:
		/**
	 ...
	 */
	ScatterBufferHelper(const size_t nInitialScatterBuffers = 5, const size_t initialGetBufferSize = 0);
	 ...
	 *	@throw	ActivException
	 */
	ScatterBufferHelper(const ScatterBufferHelper &rhs);
	 ...
	 *	@throw	ActivException
	 */
	ScatterBufferHelper& operator=(const ScatterBufferHelper &rhs);
	 ...
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 */
	StatusCode Attach(void *pData, const size_t dataLength);
	 ...
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 */
	StatusCode Attach(const ScatterBufferHelper &from, const size_t fromOffset, const size_t dataLength);
	 ...
	 *	@retval STATUS_CODE_INVALID_PARAMETER
	 */
	StatusCode Copy(const size_t offset, void *pData, const size_t dataLength) const;
	 ...
	 *	@retval STATUS_CODE_INVALID_PARAMETER
	 */
	StatusCode Copy(void *pData, const size_t dataSize, size_t &dataLength) const;
	 ...
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 */
	StatusCode Get(const size_t offset, const void *&pData, const size_t dataLength, void *pGetBuffer = 0) const;
	 ...
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 */
	StatusCode Get(const void *&pData, size_t &dataLength, void *pGetBuffer = 0, const size_t getBufferSize = 0) const;
	 ...
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 */
	StatusCode Get(const size_t offset, const void *&pData, const size_t dataLength, size_t &dataLengthRead) const;
	 ...
	 *	@retval STATUS_CODE_INVALID_PARAMETER
	 */
	StatusCode Set(const size_t offset, const void *pData, const size_t dataLength);
	 ...
	 *	@retval STATUS_CODE_INVALID_PARAMETER
	 */
	StatusCode Set(const size_t offset, const ScatterBufferHelper &from, const size_t fromOffset, const size_t dataLength);
	 ...
	 *	@retval STATUS_CODE_HEAP_EMPTY
	 */
	StatusCode AdjustGetBufferSize(const size_t getBufferSize) const;
...
inline ScatterBufferHelper::ConstIterator::ConstIterator() : m_pScatterBufferHelper(0), m_pScatterBuffer(0)
{
}
