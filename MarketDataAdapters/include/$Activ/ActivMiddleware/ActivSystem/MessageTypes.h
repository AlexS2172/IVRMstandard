 ...
 */
ACTIV_DECLARE_MESSAGE_TYPE(0,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_ASYNC_CONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(1,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_ALLOCATE_CLIENT);
ACTIV_DECLARE_MESSAGE_TYPE(2,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_INITIATE_CONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(3,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_INITIATE_DISCONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(4,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_START_LISTEN);


ACTIV_DECLARE_MESSAGE_TYPE(7,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_SYN);
ACTIV_DECLARE_MESSAGE_TYPE(8,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_FIN);
ACTIV_DECLARE_MESSAGE_TYPE(9,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_ACCEPT_CONNECTION);
ACTIV_DECLARE_MESSAGE_TYPE(10,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_UDP_INIT);
ACTIV_DECLARE_MESSAGE_TYPE(11,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_UDP_USER_SHUTDOWN);
ACTIV_DECLARE_MESSAGE_TYPE(12,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_GET_SOCKET_HANDLE);
 ...
 */
ACTIV_DECLARE_MESSAGE_TYPE(0,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_CONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(1,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_CONNECT_FAILED);
ACTIV_DECLARE_MESSAGE_TYPE(2,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_CONNECT_ABORTED);
ACTIV_DECLARE_MESSAGE_TYPE(3,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_ACCEPT);
ACTIV_DECLARE_MESSAGE_TYPE(4,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_ACCEPT_FAILED);
ACTIV_DECLARE_MESSAGE_TYPE(5,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_ACCEPT_ABORTED);
ACTIV_DECLARE_MESSAGE_TYPE(6,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_BREAK);
ACTIV_DECLARE_MESSAGE_TYPE(7,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_DISCONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(8,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_INITIATE_DISCONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(9,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_BREAK_CONNECTION);
ACTIV_DECLARE_MESSAGE_TYPE(10,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_BREAK_ACCEPTED);
ACTIV_DECLARE_MESSAGE_TYPE(11,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_STOP_LISTEN);
ACTIV_DECLARE_MESSAGE_TYPE(12,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_CIRCUIT_UP);
ACTIV_DECLARE_MESSAGE_TYPE(13,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_CIRCUIT_DOWN);
ACTIV_DECLARE_MESSAGE_TYPE(14,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_CIRCUIT_BREAK);
ACTIV_DECLARE_MESSAGE_TYPE(15,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_DATA);
ACTIV_DECLARE_MESSAGE_TYPE(16,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_CONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(17,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_DISCONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(18,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_READ);
ACTIV_DECLARE_MESSAGE_TYPE(19,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_MULTICAST_JOIN);
ACTIV_DECLARE_MESSAGE_TYPE(20,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_MULTICAST_LEAVE);
ACTIV_DECLARE_MESSAGE_TYPE(21,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_SET_MULTICAST_TTL);
ACTIV_DECLARE_MESSAGE_TYPE(22,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_SET_UNICAST_TTL);
ACTIV_DECLARE_MESSAGE_TYPE(23,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_SET_MULTICAST_INTERFACE);
ACTIV_DECLARE_MESSAGE_TYPE(24,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_SET_RX_BUFFER_SIZE);
ACTIV_DECLARE_MESSAGE_TYPE(25,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_SET_TX_BUFFER_SIZE);
ACTIV_DECLARE_MESSAGE_TYPE(26,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_SOCKET_ERROR);
ACTIV_DECLARE_MESSAGE_TYPE(27,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_SOCKET_SHUTDOWN);
ACTIV_DECLARE_MESSAGE_TYPE(28,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_SET_MULTICAST_LOOPBACK);
ACTIV_DECLARE_MESSAGE_TYPE(29,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_UDP_USER_CLEAR_MULTICAST_LOOPBACK);
ACTIV_DECLARE_MESSAGE_TYPE(30,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SET_HEAP);
ACTIV_DECLARE_MESSAGE_TYPE(31,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_CIRCUIT_FAILED);
ACTIV_DECLARE_MESSAGE_TYPE(32,	MESSAGE_CLASS_ROUTER,	ROUTER_MESSAGE_SOCKET_LISTENER_CLOSED);
