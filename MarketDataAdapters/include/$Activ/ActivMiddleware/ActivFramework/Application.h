...
public:
	...
	ACTIV_FRAMEWORK_API virtual void EnumerateProcesses(IProcessEnumerator &enumerator) const;
	ACTIV_FRAMEWORK_API virtual void EnumerateEndPoints(IEndPointEnumerator &enumerator) const;
	ACTIV_FRAMEWORK_API virtual void EnumerateHeaps(IHeapEnumerator &enumerator) const;
