...
{
public:	
	const static byte_t	NONE_REGULAR_HOUR_TRADE	= 0x01;
	 ...
	 *	@return	the result of the test.
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API bool operator==(const IntradayBar &rhs) const;
	 ...
	 *	@retval	STATUS_CODE_INVALID_LENGTH
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API StatusCode GetTotalVolume(uint32_t &volume) const;
	 ...
	 *	@retval	STATUS_CODE_INVALID_LENGTH
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API StatusCode SetTotalVolume(const uint32_t volume);
	 ...
	 *	@retval	STATUS_CODE_INVALID_LENGTH
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API StatusCode GetTickCount(uint32_t &count) const;
	 ...
	 *	@retval	STATUS_CODE_INVALID_LENGTH
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API StatusCode SetTickCount(const uint32_t count);
	 ...
	 *	@retval	STATUS_CODE_SUCCESS
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API StatusCode SetFlag(const byte_t flag);
	 ...
	 *	@retval	STATUS_CODE_SUCCESS
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API StatusCode GetFlag(byte_t &flag) const;
	 ...
	 *	@retval	STATUS_CODE_SUCCESS
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API bool IsRegularHour() const;
	 ...
	 */
	ACTIV_CONTENT_GATEWAY_COMMON_API bool HasTick();
...
inline bool IntradayBar::HasTick()
{
