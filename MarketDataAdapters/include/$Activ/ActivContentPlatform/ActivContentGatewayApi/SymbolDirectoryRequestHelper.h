...
public:
	 ...
	 *	@retval	...
	 */
	ACTIV_CONTENT_GATEWAY_API static StatusCode GetResponse(const ContentGatewayClient &client, SyncRequestId &syncRequestId, ResponseParameters &responseParameters, const TimeoutPeriod timeoutPeriod);
