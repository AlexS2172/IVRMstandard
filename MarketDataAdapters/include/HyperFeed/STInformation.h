...
typedef struct _ST_PACKETSTATS 
{
	ULONG	pps;
	ULONG	packets;
	ULONG	maxPPS;
...
#define DBA_INFORMATION_RECTYPE_PACKET_STATS	15
#define DBA_INFORMATION_MAX_RECTYPE				15
...
#define ST_STATS_PROGRAM_NAME_PACKET_STATS	"PacketStats"
