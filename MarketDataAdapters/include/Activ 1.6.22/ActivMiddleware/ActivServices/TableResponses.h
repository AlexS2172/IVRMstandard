...
public:
	...
	/**
	 *	@brief	Process a database response. Calls the correct On*Response() by response.GetType().
	 *
	 ...
	 */
	ACTIV_SERVICES_API virtual StatusCode ProcessResponse(HeapMessage &response);
