...
public:
	 ...
	 *	@throw	Exception.
	 */
	ACTIV_BASE_API StatusCode WaitForCompletion() const;
     ...
     *	@return	Thread id.
     */
	ACTIV_BASE_API ThreadId GetId() const;
...
protected:
     ...
     */
	ACTIV_BASE_API virtual bool OnStart();
     ...
     */
	ACTIV_BASE_API virtual void OnStop();
