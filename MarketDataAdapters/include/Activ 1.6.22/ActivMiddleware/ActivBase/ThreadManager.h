...
public:
	 ...
	 *	@throw	Exception
     */
    ACTIV_BASE_API ThreadManager(const size_t maxCount);

    /**
     *	@brief	Destructor.
     */
	ACTIV_BASE_API virtual ~ThreadManager();
     ...
     */
	ACTIV_BASE_API StatusCode StartThread(ManagedThread &thread, void *pData = 0, const size_t stackSize = 0);
	 ...
	 *	@retval	ACTUV_STATUS_CODE_FULL
     */
	ACTIV_BASE_API StatusCode StartThread(ThreadFunction *pFunction, void *pData = 0, const size_t stackSize = 0);
     ...
     */
	ACTIV_BASE_API StatusCode WaitOnEmpty(const TimeoutPeriod timeout = ACTIV_WAIT_INFINITE);
     ...
     */
	ACTIV_BASE_API size_t GetCount() const;
...
protected:
     ...
     */
	ACTIV_BASE_API virtual bool OnThreadStart(ManagedThread &thread, void *pData);
     ...
     */
	ACTIV_BASE_API virtual void OnThreadStop(ManagedThread &thread);
