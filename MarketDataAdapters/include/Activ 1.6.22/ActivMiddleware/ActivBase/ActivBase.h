 ...
 *
 *	@param	osProcessId the process id to wait for.
 *	@param	timeoutPeriod the timeout period to wait.
 *
 *	@retval	STATUS_CODE_SUCCESS
 *	@retval	STATUS_CODE_FAILURE
 */
ACTIV_BASE_API StatusCode WaitForProcessToExit(const OsProcessId osProcessId, const TimeoutPeriod timeoutPeriod = ACTIV_WAIT_INFINITE);

/**
 *	@brief	Does process exist?
 *
 *	@param	osProcessId the os process id.
 *
 *	@return	true if the process exists.
 */
ACTIV_BASE_API bool DoesProcessExist(const OsProcessId osProcessId);
