...
public:
	 ...
	 */
	ACTIV_FIELD_TYPES_API static int64_t ConvertGregorianToJulianDateTime(const int32_t year, const int32_t month, const int32_t day, const uint32_t hour, const uint32_t minute, const uint32_t second);
