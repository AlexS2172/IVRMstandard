...
public:
	...
	Activ::uint32_t	m_uploadAttempts;							///< The number of attempts to upload the update.
	Activ::uint32_t	m_uploadAttemptInterval;					///< The interval between upload attempts.
