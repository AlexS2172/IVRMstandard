...
public:
	 ...
	 *
	 *	NB can be called from any thread, but the mutex *must* already be locked.
	 *
	 ...
	 *
	 *	NB this *must* be called from the context of the event manager's thread, and the mutex *must*
	 *	already be locked.
	 *
	 *	@retval	STATUS_CODE_SUCCESS
	 *	@retval	...
