...
public:
	...
	public:
		...
		enum Policy
		{
			...
			POLICY_FIND_NEXT_ALTERNATIVE,	///< Attempt to connect to the next gateway in the list
			POLICY_FIND_RANDOM_ALTERNATIVE	///< Attempt to connect to a randomly chosen gateway
		};
...
protected:
	...
	ACTIV_CONTENT_GATEWAY_API virtual void OnGetMultipleMatchResponse(HeapMessage &response);
