...
inline StatusCode AddressInfo::Deserialize(MessageValidator &messageValidator)
{
	ACTIV_RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, messageValidator.ValidateString(&m_protocol));
	ACTIV_RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, m_localAddress.Deserialize(messageValidator));
	ACTIV_RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, m_remoteAddress.Deserialize(messageValidator));
