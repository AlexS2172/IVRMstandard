...
public:
	 ...
	 *	@return	boolean.
	 */
	ACTIV_FRAMEWORK_API BaseTime &operator+=(const int64_t numberOfMilliseconds);
	 ...
	 *
	 *	@param	shouldFormatMilliseconds whether to put the millisecond portion in the string.
	 *
	 *	@return	A string containing date and time in current locale.
	 */
	ACTIV_FRAMEWORK_API std::string ToString(const bool shouldFormatMilliseconds = false) const;
	 ...
	 */
	ACTIV_FRAMEWORK_API std::string TimeToString(const bool shouldFormatMilliseconds = false) const;
	 ...
	 *	@brief	Deserialize.
	 *
	 *	@param	messageValidator validator to deserialize with.
	 *
	 *	@retval	STATUS_CODE_SUCCESS.
	 *	@retval	...
	 */
