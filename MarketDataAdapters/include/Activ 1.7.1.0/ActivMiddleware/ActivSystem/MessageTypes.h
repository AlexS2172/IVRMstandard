...
#define ACTIV_MESSAGE_CLASS_LIST(d)											\
	...
	d(14,	MESSAGE_CLASS_LICENSE,			"License")						\
...
ACTIV_DECLARE_MESSAGE_TYPE(2,	MESSAGE_CLASS_TIMER,	TIMER_REQUEST_ADJUST_SYSTEM_TIME);
...
ACTIV_DECLARE_MESSAGE_TYPE(13,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_CONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(14,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_DISCONNECT);
ACTIV_DECLARE_MESSAGE_TYPE(15,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_MULTICAST_JOIN);
ACTIV_DECLARE_MESSAGE_TYPE(16,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_MULTICAST_LEAVE);
ACTIV_DECLARE_MESSAGE_TYPE(17,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_SET_MULTICAST_TTL);
ACTIV_DECLARE_MESSAGE_TYPE(18,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_SET_UNICAST_TTL);
ACTIV_DECLARE_MESSAGE_TYPE(19,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_SET_MULTICAST_INTERFACE);
ACTIV_DECLARE_MESSAGE_TYPE(20,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_SET_RX_BUFFER_SIZE);
ACTIV_DECLARE_MESSAGE_TYPE(21,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_SET_TX_BUFFER_SIZE);
ACTIV_DECLARE_MESSAGE_TYPE(22,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_SET_MULTICAST_LOOPBACK);
ACTIV_DECLARE_MESSAGE_TYPE(23,	MESSAGE_CLASS_ROUTER,	ROUTER_REQUEST_USER_UDP_CLEAR_MULTICAST_LOOPBACK);
...
ACTIV_DECLARE_MESSAGE_TYPE(11,	MESSAGE_CLASS_UI,		UI_MESSAGE_PARTIAL_USER_INPUT);
ACTIV_DECLARE_MESSAGE_TYPE(12,	MESSAGE_CLASS_UI,		UI_MESSAGE_SET_INPUT);
ACTIV_DECLARE_MESSAGE_TYPE(13,	MESSAGE_CLASS_UI,		UI_MESSAGE_UNBUFFERED_OUTPUT);
