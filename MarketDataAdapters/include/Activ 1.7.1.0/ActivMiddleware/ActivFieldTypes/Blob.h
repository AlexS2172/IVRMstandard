...
public:
	 ...
	 *	@retval	...
	 */
	ACTIV_FIELD_TYPES_API static StatusCode Deserialize(MessageValidator &messageValidator, const size_t maxSerializedBodyLength, const uint8_t *&pData, size_t &size, size_t &decompressedSize);
	 ...
	 *	@retval	...
	 */
	ACTIV_FIELD_TYPES_API static StatusCode DeserializeLengthAndBody(MessageValidator &messageValidator, const size_t maxSerializedBodyLength, const uint8_t *&pData, size_t &size, size_t &decompressedSize);
