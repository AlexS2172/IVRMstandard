...
public:
	...
	public:
		...
		/**
		 *	@brief	Get a list of string values for this key.
		 *
		 *	@param	valueList reference to a vector to @a append the strings to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 *
		 *	@retval	STATUS_CODE_SUCCESS
		 */
		ACTIV_BASE_API StatusCode GetStringValueList(std::vector<std::string> &valueList, const std::string &delimiterList = std::string(",")) const;
		...
		/**
		 *	@brief	Get a list of signed integral values for this key.
		 *
		 *	@param	valueList reference to a vector to @a append the values to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 *
		 *	@retval	STATUS_CODE_SUCCESS
		 *	@retval	STATUS_CODE_OUT_OF_RANGE a parsed value is out of range of type T
		 *	@retval	STATUS_CODE_INVALID_FORMAT a parsed value is not a signed value
		 */
		template<typename T>
		ACTIV_TEMPLATE_API(ACTIV_BASE_API) StatusCode GetSignedValueList(std::vector<T> &valueList, const std::string &delimiterList = std::string(",")) const;
		...
		/**
		 *	@brief	Get a list of unsigned integral values for this key.
		 *
		 *	@param	valueList reference to a vector to @a append the values to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 *
		 *	@retval	STATUS_CODE_SUCCESS
		 *	@retval	STATUS_CODE_OUT_OF_RANGE a parsed value is out of range of type T
		 *	@retval	STATUS_CODE_INVALID_FORMAT a parsed value is not an unsigned value
		 */
		template<typename T>
		ACTIV_TEMPLATE_API(ACTIV_BASE_API) StatusCode GetUnsignedValueList(std::vector<T> &valueList, const std::string &delimiterList = std::string(",")) const;
		...
		/**
		 *	@brief	Get a list of real values for this key.
		 *
		 *	@param	valueList reference to a vector to @a append the values to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 *
		 *	@retval	STATUS_CODE_SUCCESS
		 *	@retval	STATUS_CODE_OUT_OF_RANGE a parsed value is out of range of type T
		 *	@retval	STATUS_CODE_INVALID_FORMAT a parsed value is not a real value
		 */
		ACTIV_BASE_API StatusCode GetRealValueList(std::vector<double> &valueList, const std::string &delimiterList = std::string(",")) const;
	...
	public:
		...
		/**
		 *	@brief	Get a list of string values for a key in this section.
		 *
		 *	@param	keyName key to get values of.
		 *	@param	valueList reference to a vector to @a append the strings to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 *
		 *	@retval	STATUS_CODE_SUCCESS
		 *	@retval	STATUS_CODE_NOT_FOUND key not found
		 */
		ACTIV_BASE_API StatusCode GetStringValueList(const std::string &keyName, std::vector<std::string> &valueList, const std::string &delimiterList = std::string(",")) const;
		...
		/**
		 *	@brief	Get a list of signed integral values for a key in this section.
		 *
		 *	@param	keyName key to get values of.
		 *	@param	valueList reference to a vector to @a append the values to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 ...
		 */
		template<typename T>
		StatusCode GetSignedValueList(const std::string &keyName, std::vector<T> &valueList, const std::string &delimiterList = std::string(",")) const;
		...
		/**
		 *	@brief	Get a list of unsigned integral values for a key in this section.
		 *
		 *	@param	keyName key to get values of.
		 *	@param	valueList reference to a vector to @a append the values to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 ...
		 */
		template<typename T>
		StatusCode GetUnsignedValueList(const std::string &keyName, std::vector<T> &valueList, const std::string &delimiterList = std::string(",")) const;
		...
		/**
		 *	@brief	Get a list of real values for a key in this section.
		 *
		 *	@param	keyName key to get values of.
		 *	@param	valueList reference to a vector to @a append the values to.
		 *	@param	delimiterList list of valid value delimiter characters.
		 ...
		 *	@retval	STATUS_CODE_NOT_FOUND key not found
		 */
		ACTIV_BASE_API StatusCode GetRealValueList(const std::string &keyName, std::vector<double> &valueList, const std::string &delimiterList = std::string(",")) const;
	...
	/**
	 *	@brief	Constructor. Parses an ini file from a buffer.
	 *
	 ...
	 *	@throw	ParseException
	 */
	ACTIV_BASE_API IniFileParser(const byte_t * const pBuffer, const size_t bufferLength);
	 ...
	 *	@retval	STATUS_CODE_NOT_FOUND section or key not found
	 */
	ACTIV_BASE_API StatusCode GetStringValueList(const std::string &sectionName, const std::string &keyName,
												 std::vector<std::string> &valueList, const std::string &delimiterList = std::string(",")) const;
	...
	/**
	 *	@brief	Get list of signed integral values for a (section, key).
	 *
	 *	@param	sectionName section to look for key.
	 *	@param	keyName key to get values of.
	 *	@param	valueList reference to a vector to @a append the values to.
	 ...
	 */
	template<typename T>
	StatusCode GetSignedValueList(const std::string &sectionName, const std::string &keyName,
								  std::vector<T> &valueList, const std::string &delimiterList = std::string(",")) const;
	...
	/**
	 *	@brief	Get list of unsigned integral values for a (section, key).
	 *
	 *	@param	sectionName section to look for key.
	 *	@param	keyName key to get values of.
	 *	@param	valueList reference to a vector to @a append the values to.
	 ...
	 */
	template<typename T>
	StatusCode GetUnsignedValueList(const std::string &sectionName, const std::string &keyName,
									std::vector<T> &valueList, const std::string &delimiterList = std::string(",")) const;
	...
	/**
	 *	@brief	Get list of real values for a (section, key).
	 *
	 *	@param	sectionName section to look for key.
	 *	@param	keyName key to get values of.
	 *	@param	valueList reference to a vector to @a append the values to.
	 ...
	 *	@retval	STATUS_CODE_NOT_FOUND section or key not found
	 */
	ACTIV_BASE_API StatusCode GetRealValueList(const std::string &sectionName, const std::string &keyName,
											   std::vector<double> &valueList, const std::string &delimiterList = std::string(",")) const;
...
template<typename T>
StatusCode IniFileParser::GetSignedValueList(const std::string &sectionName, const std::string &keyName, std::vector<T> &valueList, const std::string &delimiterList) const
{
	ConstSectionIterator iter = FindSection(sectionName);
	...
	return iter.GetSignedValueList(keyName, valueList, delimiterList);
}
...
template<typename T>
StatusCode IniFileParser::GetUnsignedValueList(const std::string &sectionName, const std::string &keyName, std::vector<T> &valueList, const std::string &delimiterList) const
{
	ConstSectionIterator iter = FindSection(sectionName);
	...
	return iter.GetUnsignedValueList(keyName, valueList, delimiterList);
}
...
template<typename T>
StatusCode IniFileParser::ConstSectionIterator::GetSignedValueList(const std::string &keyName, std::vector<T> &valueList, const std::string &delimiterList) const
{
	ConstKeyIterator iter = FindKey(keyName);
	...
	return iter.GetSignedValueList(valueList, delimiterList);
}
...
template<typename T>
StatusCode IniFileParser::ConstSectionIterator::GetUnsignedValueList(const std::string &keyName, std::vector<T> &valueList, const std::string &delimiterList) const
{
	ConstKeyIterator iter = FindKey(keyName);
	...
	return iter.GetUnsignedValueList(valueList, delimiterList);
}
