...
#define ACTIV_STATUS_CODE_LIST(d)											\
	...
	d(62,	STATUS_CODE_BUSY, "busy")										\
	d(63,	STATUS_CODE_EXPIRED, "expired")									\
	d(64,	STATUS_CODE_HOST_UNREACHABLE, "host unreachable")				\
	d(65,	STATUS_CODE_NETWORK_UNREACHABLE, "network unreachable")			\
	d(66,	STATUS_CODE_NOT_LICENSED, "not licensed")						\
	d(67,	STATUS_CODE_ADDRESS_NOT_AVAILABLE, "address not available")		\
	d(68,	STATUS_CODE_NO_SUCH_DEVICE, "no such device")
 ...
 */
#define ACTIV_DECLARE_STATUS_CODE(value, id, name)	const StatusCode id = value;
