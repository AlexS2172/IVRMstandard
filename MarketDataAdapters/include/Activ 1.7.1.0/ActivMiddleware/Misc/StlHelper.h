 ...
 *  @file	StlHelper.h
 *
 *	@brief	Work arounds for stl disparities across platforms, plus various helpers.
 *
 *	$Log: $
 */

#if (!defined ACTIV_MISC_STL_HELPER_H)
#define ACTIV_MISC_STL_HELPER_H
...
#if (defined ACTIV_COMPILER_VISUAL_C) || (defined ACTIV_COMPILER_INTEL)
using ACTIV_STL_HELPER_EXT_NAMESPACE::_Hash;
using ACTIV_STL_HELPER_EXT_NAMESPACE::_Hmap_traits;
using ACTIV_STL_HELPER_EXT_NAMESPACE::_Hset_traits;
#endif
 ...
 */
template<typename MAPPED_TYPE, typename KEY_TYPE>
inline bool MapFind(MAPPED_TYPE &map, const KEY_TYPE &key, typename MAPPED_TYPE::iterator &iter)
{
 ...
 */
template<typename MAPPED_TYPE, typename KEY_TYPE>
inline std::pair<typename MAPPED_TYPE::iterator, bool> MapInsert(MAPPED_TYPE &map, const KEY_TYPE &key, typename MAPPED_TYPE::value_type &value)
{
	const_cast<typename MAPPED_TYPE::key_type &>(value.first) = key;
 ...
 */
template<typename MAPPED_TYPE, typename KEY_TYPE>
inline typename MAPPED_TYPE::iterator MapInsert(MAPPED_TYPE &map, typename MAPPED_TYPE::iterator hint, const KEY_TYPE &key, typename MAPPED_TYPE::value_type &value)
{
	const_cast<typename MAPPED_TYPE::key_type &>(value.first) = key;
...
#endif // (!defined ACTIV_MISC_STL_HELPER_H)
