...
#define ACTIV_CONTENT_PLATFORM_MESSAGE_CLASS_LIST(d)						\
	...
	d(35,	MESSAGE_CLASS_REFRESH_REQUESTER,	"RefreshRequester")			\
	d(36,	MESSAGE_CLASS_HISTORY_MANAGER,		"History Manager")			\
	d(37,	MESSAGE_CLASS_INGEST,				"Ingest")					\
	d(38,	MESSAGE_CLASS_NEWS_SERVER,			"News Server")				\
	d(39,	MESSAGE_CLASS_WORKSTATION_SERVICE,	"Workstation Service")		\
	d(40,	MESSAGE_CLASS_PUBLISHING_GATEWAY,	"PublishingGateway")
