...
public:
	 ...
	 *	@retval	...
	 */
	ACTIV_FEED_API static StatusCode GetResponse(const ContentGatewayClient &client, SyncRequestId &syncRequestId, ResponseParameters &responseParameters, const TimeoutPeriod timeoutPeriod = Port::defaultTimeout);
