...
#if (!defined ACTIV_FEED_API_COMMON_FIELD_SET_H)
#define ACTIV_FEED_API_COMMON_FIELD_SET_H
...
public:
	...
	ACTIV_FEED_API_COMMON_API static const std::string	DEFAULT_STRING_FIELD_SEPARATER;
	 ...
	 *	@brief	Destructor.
	 */
	ACTIV_FEED_API_COMMON_API virtual ~FieldSet();
	 ...
	 *
	 *	@param	previous previous field set in this stream.
	 *	@param	validator bit validator for decompression.
	 *
	 *	@retval	STATUS_CODE_SUCCESS
	 *	@retval	STATUS_CODE_BUFFER_OVERFLOW
	 *	@retval	...
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Compress(const Date &previous, const Date &date, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode CompressWithCheck(const Date &previous, const Date &date, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Decompress(const Date &previous, Date &date, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode DecompressWithCheck(const Date &previous, Date &date, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Compress(const Time &previous, const Time &time, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode CompressWithCheck(const Time &previous, const Time &time, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Decompress(const Time &previous, Time &time, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode DecompressWithCheck(const Time &previous, Time &time, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Compress(const uint64_t &previous, const uint64_t &current, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode CompressWithCheck(const uint64_t &previous, const uint64_t &current, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Decompress(const uint64_t &previous, uint64_t &current, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode DecompressWithCheck(const uint64_t &previous, uint64_t &current, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Compress(const Rational::Denominator &previous, const Rational::Denominator &current, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode CompressWithCheck(const Rational::Denominator &previous, const Rational::Denominator &current, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Decompress(const Rational::Denominator &previous, Rational::Denominator &current, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode DecompressWithCheck(const Rational::Denominator &previous, Rational::Denominator &current, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Compress(const Rational &previous, const Rational &current, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode CompressWithCheck(const Rational &previous, const Rational &current, BitBuilder &builder);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode Decompress(const Rational &previous, Rational &current, BitValidator &validator);
	 ...
	 *	@retval	...
	 */
	//ACTIV_FEED_API_COMMON_API static StatusCode DecompressWithCheck(const Rational &previous, Rational &current, BitValidator &validator);

	ACTIV_FEED_API_COMMON_API static char *RationalToDoubleString(const Rational &rational, char *buffer);
	 ...
	 *	@retval	...
	 */
	ACTIV_FEED_API_COMMON_API static StatusCode ReadDate(const std::string &input,  const std::string &deliminator, std::string::size_type &startingPos, Date &dateOut);
	 ...
	 *	@retval	...
	 */
	ACTIV_FEED_API_COMMON_API static StatusCode ReadTime(const std::string &input,  const std::string &deliminator, std::string::size_type &startingPos, Time &timeOut);
	 ...
	 *	@retval	...
	 */
	ACTIV_FEED_API_COMMON_API static StatusCode ReadDateTime(const std::string &input,  const std::string &deliminator, std::string::size_type &startPos, DateTime &dateTimeOut);
	 ...
	 *	@retval	...
	 */
	ACTIV_FEED_API_COMMON_API static StatusCode ReadRationalFromDoubleString(const std::string &input,  const std::string &deliminator, std::string::size_type &startPos, Rational &rationalOut);
...
public:
	...
	typedef SerializableObjectContainerHelper<std::list<OBJECT_TYPE>, COUNT_TYPE> Serializer;
...
#endif // (!defined ACTIV_FEED_API_COMMON_FIELD_SET_H)
