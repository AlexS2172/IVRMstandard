...
#if (!defined ACTIV_FEED_API_COMMON_TIME_SERIES_TYPES_H)
#define ACTIV_FEED_API_COMMON_TIME_SERIES_TYPES_H
 ...
 */
ACTIV_FEED_API_COMMON_API std::string SeriesTypeToString(const SeriesType seriesType);
 ...
 */
ACTIV_FEED_API_COMMON_API std::string RecordFilterTypeToString(const RecordFilterType recordFilterType);
...
#define ACTIV_TIME_SERIES_INTRADAY_RECORD_FILTER_TYPE_LIST(d)					\
	d(0,	INTRADAY_RECORD_FILTER_TYPE_REGULAR_TRADES,	"Regular Trades Only")	\
	d(1,	INTRADAY_RECORD_FILTER_TYPE_ALL,			"All Trades")			\
	d(2,	INTRADAY_RECORD_FILTER_TYPE_ALL_PLUS_VWAP,	"All + VWAP Only Bars")
 ...
 *	@return	String representation of \a recordFilterType.
 */
ACTIV_FEED_API_COMMON_API std::string FieldFilterTypeToString(const FieldFilterType fieldFilterType);
 ...
 */
ACTIV_FEED_API_COMMON_API std::string PeriodTypeToString(const PeriodType periodType);
...
public:
	 ...
	 */
	ACTIV_FEED_API_COMMON_API bool operator==(const DataPointAddress &rhs) const;
...
public:
	 ...
	 *	@return	whether the two objects are equal.
	 */
	ACTIV_FEED_API_COMMON_API bool operator==(const Period &rhs) const;
...
public:
	 ...
	 */
	ACTIV_FEED_API_COMMON_API TimeSeriesRequestParameters();
	...
	#define ACTIV_TIME_SERIES_REQUEST_FLAG_LIST(d)											\
		d(0x0000,	FLAG_NONE)																\
		d(0x0001,	FLAG_REVERSE)								/** Reverse series flag */

	typedef uint16_t Flags;										///< Request flags type
	ACTIV_TIME_SERIES_REQUEST_FLAG_LIST(ACTIV_DECLARE_FLAGS)
	...
	uint8_t				m_specifiedInterval;					///< for series type of INTRADAY_SERIES_TYPE_SPECIFIED_MINUTE only, valid values are 1, 2, 3, 5, 6, 10, 15, 30, 60
};
...
public:
	 ...
	 */
	ACTIV_FEED_API_COMMON_API const SymbolId &GetSymbolId() const;
	 ...
	 */
	ACTIV_FEED_API_COMMON_API const DataPointAddress &GetDataPointAddress() const;
...
#undef ACTIV_DECLARE_CONSTANT_SERIES_TYPE
...
#endif // (!defined ACTIV_FEED_API_COMMON_TIME_SERIES_TYPES_H)
