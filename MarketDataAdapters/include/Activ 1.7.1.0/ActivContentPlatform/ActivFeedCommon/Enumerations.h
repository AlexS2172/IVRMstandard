...
typedef uint8_t DisplayDenominator;	///< The display denominator type definition.

const DisplayDenominator DISPLAY_DENOMINATOR_WHOLE = 0;
const DisplayDenominator DISPLAY_DENOMINATOR_1DP = 1;
const DisplayDenominator DISPLAY_DENOMINATOR_2DP = 2;
const DisplayDenominator DISPLAY_DENOMINATOR_3DP = 3;
const DisplayDenominator DISPLAY_DENOMINATOR_4DP = 4;
const DisplayDenominator DISPLAY_DENOMINATOR_5DP = 5;
const DisplayDenominator DISPLAY_DENOMINATOR_6DP = 6;
const DisplayDenominator DISPLAY_DENOMINATOR_7DP = 7;
const DisplayDenominator DISPLAY_DENOMINATOR_8DP = 8;
const DisplayDenominator DISPLAY_DENOMINATOR_9DP = 9;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E1 = 10;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E2 = 11;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E3 = 12;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E4 = 13;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E5 = 14;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E6 = 15;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E7 = 16;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E8 = 17;
const DisplayDenominator DISPLAY_DENOMINATOR_X1E9 = 18;
const DisplayDenominator DISPLAY_DENOMINATOR_HALF = 19;
const DisplayDenominator DISPLAY_DENOMINATOR_QUARTER = 20;
const DisplayDenominator DISPLAY_DENOMINATOR_8TH = 21;
const DisplayDenominator DISPLAY_DENOMINATOR_16TH = 22;
const DisplayDenominator DISPLAY_DENOMINATOR_32ND = 23;
const DisplayDenominator DISPLAY_DENOMINATOR_64TH = 24;
const DisplayDenominator DISPLAY_DENOMINATOR_128TH = 25;
const DisplayDenominator DISPLAY_DENOMINATOR_256TH = 26;
const DisplayDenominator DISPLAY_DENOMINATOR_512TH = 27;
const DisplayDenominator DISPLAY_DENOMINATOR_CABINET = 28;
const DisplayDenominator DISPLAY_DENOMINATOR_UNDEFINED = 29;
const DisplayDenominator DISPLAY_DENOMINATOR_RESERVED_1 = 30;
const DisplayDenominator DISPLAY_DENOMINATOR_RESERVED_2 = 31;
const DisplayDenominator DISPLAY_DENOMINATOR_REDUCED_FRACTION = 32;
const DisplayDenominator DISPLAY_DENOMINATOR_HALF_23ND = 33;
const DisplayDenominator DISPLAY_DENOMINATOR_HALF_64TH = 34;
...
typedef uint8_t ExpirationType;	///< The exercise type type definition.

const ExpirationType EXPIRATION_TYPE_MID_MONTH = 0;
const ExpirationType EXPIRATION_TYPE_FIRST_FRIDAY = 1;
const ExpirationType EXPIRATION_TYPE_SECOND_FRIDAY = 2;
const ExpirationType EXPIRATION_TYPE_THIRD_FRIDAY = 3;
const ExpirationType EXPIRATION_TYPE_FOURTH_FRIDAY = 4;
const ExpirationType EXPIRATION_TYPE_FIFTH_FRIDAY = 5;
const ExpirationType EXPIRATION_TYPE_WEDNESDAY_MID_MONTH = 6;

typedef uint16_t NewsState;	///< The news state type definition.

const NewsState NEWS_STATE_BIT_HOT = 0;
const NewsState NEWS_STATE_BIT_TEMPORARY = 1;
const NewsState NEWS_STATE_BIT_DISABLE_NEWS_ALERT = 2;

const NewsState NEWS_STATE_HOT = (1 << ((sizeof(NewsState) * CHAR_BIT) - (NEWS_STATE_BIT_HOT + 1)));
const NewsState NEWS_STATE_TEMPORARY = (1 << ((sizeof(NewsState) * CHAR_BIT) - (NEWS_STATE_BIT_TEMPORARY + 1)));
const NewsState NEWS_STATE_DISABLE_NEWS_ALERT = (1 << ((sizeof(NewsState) * CHAR_BIT) - (NEWS_STATE_BIT_DISABLE_NEWS_ALERT + 1)));

const NewsState NEWS_STATE_NONE = 0;
...
typedef uint8_t OrderType;	///< The order type type definition.

const OrderType ORDER_TYPE_LIMIT_ORDER = 0;
const OrderType ORDER_TYPE_MARKET_ORDER = 1;
const OrderType ORDER_TYPE_ALL_OR_NONE = 2;
const OrderType ORDER_TYPE_LOTS_OF = 3;
const OrderType ORDER_TYPE_MINIMUM_FILL = 4;
const OrderType ORDER_TYPE_SPECIAL = 5;
...
typedef uint8_t SplitType;	///< The split type type definition.

const SplitType SPLIT_TYPE_SPLIT = 0;
const SplitType SPLIT_TYPE_REVERSE = 1;
const SplitType SPLIT_TYPE_DISTRIBUTION = 2;
const SplitType SPLIT_TYPE_REDUCTION = 3;
const SplitType SPLIT_TYPE_PRICE_ADJUSTMENT = 4;
