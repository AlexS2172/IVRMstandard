...
const TableNo TABLE_NO_AMERICAS_LISTING = 5;
...
const TableNo TABLE_NO_US_LISTING_BBO10 = 19;
...
const TableNo TABLE_NO_AMERICAS_FUTURE = 42;
const TableNo TABLE_NO_AMERICAS_EQUITY_OPTION = 43;
const TableNo TABLE_NO_AMERICAS_FUTURE_OPTION = 44;
const TableNo TABLE_NO_US_FUTURE_BBO10 = 50;
const TableNo TABLE_NO_US_FUTURE_OPTION_BBO10 = 51;
const TableNo TABLE_NO_AMERICAS_LISTING_BBO10 = 52;
const TableNo TABLE_NO_AMERICAS_FUTURE_BBO10 = 53;
const TableNo TABLE_NO_AMERICAS_EQUITY_OPTION_BBO10 = 54;
const TableNo TABLE_NO_AMERICAS_FUTURE_OPTION_BBO10 = 55;
...
const TableNo TABLE_NO_FUTURE_OPTION_ROOT_FUTURE_OPTION_PATTERN_NAVIGATION = 102;
...
const TableNo TABLE_NO_UNDERLYING_OPTION_PATTERN_NAVIGATION = 116;
const TableNo TABLE_NO_FUTURE_FUTURE_OPTION_PATTERN_NAVIGATION = 117;
const TableNo TABLE_NO_FUTURE_ROOT_FUTURE_PATTERN_NAVIGATION = 118;
...
const TableNo TABLE_NO_CONTRIBUTION_USER = 303;
const TableNo TABLE_NO_FEED_STATUS = 350;
const TableNo TABLE_NO_LATENCY = 351;
...
const TableNo TABLE_NO_TABLE_TEMPLATE_LIST_METADATA = 700;
const TableNo TABLE_NO_UNIVERSAL_FIELD_LIST_METADATA = 701;
const TableNo TABLE_NO_TABLE_TEMPLATE_FIELD_LIST_METADATA = 702;
const TableNo TABLE_NO_TABLE_TEMPLATE_INDEX_LIST_METADATA = 703;
const TableNo TABLE_NO_TABLE_TEMPLATE_INDEX_FIELD_LIST_METADATA = 704;
const TableNo TABLE_NO_PERMISSION_METADATA = 705;
