...
const PermissionId PERMISSION_ID_LIST = PERMISSION_ID_UNKNOWN - 1;
...
const PermissionId PERMISSION_ID_MONTREAL_LEVEL1 = 43;
...
const PermissionId PERMISSION_ID_TSX_FOREX = 47;

const PermissionId PERMISSION_ID_ASX = 48;

const PermissionId PERMISSION_ID_HEMSCOTT = 49;

const PermissionId PERMISSION_ID_CNQ = 50;

const PermissionId PERMISSION_ID_COMTEX_PUBCO_CANADA = 51;
const PermissionId PERMISSION_ID_COMTEX_PUBLIC_COMPANIES = 52;

const PermissionId PERMISSION_ID_WORKSTATION_FULL = 53;

const PermissionId PERMISSION_ID_NEWSTEX = 54;

const PermissionId PERMISSION_ID_AMX = 55;

const PermissionId PERMISSION_ID_PBOT = 56;

const PermissionId PERMISSION_ID_TSX_NEWS = 57;

const PermissionId PERMISSION_ID_NASDAQ_TOTAL_VIEW = 58;

const PermissionId PERMISSION_ID_NYSE_OPEN_BOOK = 59;

const PermissionId PERMISSION_ID_MONTREAL_LEVEL2 = 60;

const PermissionId PERMISSION_ID_MIDNIGHT_TRADER = 61;

const PermissionId PERMISSION_ID_NASDAQ_OPEN_VIEW = 62;

const PermissionId PERMISSION_ID_COUNT = 63;
