...
const FieldId FID_NEXT_SPECIAL_DIVIDEND_1 = 751;
const FieldId FID_NEXT_SPECIAL_DIVIDEND_1_DATE = 752;
const FieldId FID_EXPIRATION_TYPE = 753;
const FieldId FID_VWAP_CUMULATIVE_VALUE = 754;
const FieldId FID_VWAP_CUMULATIVE_VOLUME = 755;
const FieldId FID_SEQUENCE_NUMBER = 756;
const FieldId FID_RELATIONSHIP_TYPE = 757;
const FieldId FID_OPTION_PATTERN_SYMBOL = 758;
const FieldId FID_OPTION_PATTERN_TABLE_NO = 759;
const FieldId FID_SHOULD_WATCH = 760;
const FieldId FID_LANGUAGE = 761;
const FieldId FID_CHARACTER_SET = 762;
const FieldId FID_NEWS_STATE = 763;
const FieldId FID_NEXT_NEWS_SYMBOL = 764;
const FieldId FID_PREVIOUS_NEWS_SYMBOL = 765;
const FieldId FID_FEED_LATENCY = 766;
const FieldId FID_SYSTEM_LATENCY = 767;
const FieldId FID_SYSTEM_TIMESTAMP = 768;
const FieldId FID_FUTURE_OPTION_PATTERN_SYMBOL = 769;
const FieldId FID_FUTURE_OPTION_PATTERN_TABLE_NO = 770;
const FieldId FID_FUTURE_PATTERN_SYMBOL = 771;
const FieldId FID_FUTURE_PATTERN_TABLE_NO = 772;
const FieldId FID_EXCHANGE_CODE_LIST = 773;
const FieldId FID_TABLE_NUMBER_LIST = 774;
const FieldId FID_MAXIMUM_MESSAGE_RATE = 775;
const FieldId FID_LAST_REPORTED_TRADE = 776;
const FieldId FID_LAST_REPORTED_TRADE_SIZE = 777;
const FieldId FID_LAST_REPORTED_TRADE_CONDITION = 778;
const FieldId FID_LAST_REPORTED_TRADE_TIME = 779;
const FieldId FID_LAST_REPORTED_TRADE_DATE = 780;
const FieldId FID_LAST_REPORTED_TRADE_EXCHANGE = 781;
const FieldId FID_SUBSCRIPTION_QUOTA = 782;
const FieldId FID_STRIKE_PRICE_DENOMINATOR = 783;
const FieldId FID_FUND_CODE = 784;
const FieldId FID_MARKET_TIER = 785;
const FieldId FID_CREATE_TIME = 786;
