...
// 
  ...
  typedef struct  _PCQT1111_KEY_0_100     //  interest rate records
 {
...

   {
    ...
    USHORT  calendarSequence;             //   for weekly expiration indecates week
                                          //     of the month
...
//
  ...
  typedef struct     _SYMBOL_DEF
  {
    ...
    union                             //  table of PCQUOTE standard
                                      //  exchange codes
    {                     
    ...
    struct                            //  ordered table of option
...
//
  ...
  typedef struct     _UNDERLYING_SEC
  {
    ...
    }                 specialDiv[4];  //  table of up to 4 special dividends

    LONG              volatility;     //  26 week historical volatility
